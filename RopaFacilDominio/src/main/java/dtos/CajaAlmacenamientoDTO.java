...
/**
 * Clase CajaAlmacenamientoDTO. Se relaciona con ProductoDTO.
 * Tipo de Dato de Transferencia.
 * @author Leonardo Flores Leyva - 252390
 */
public class CajaAlmacenamientoDTO {
    /**
